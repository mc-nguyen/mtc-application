export const translations = {
    vi: {
        // ==================== TRANG CHỦ & CHUNG ====================
        homepage_title: "Chào mừng đến với ứng dụng ghi danh Thiếu Nhi Thánh Thể của Đoàn Mẹ Thiên Chúa",
        homepage_subtitle: "Chọn một tùy chọn bên dưới để tiếp tục.",
        homepage_register_btn: "Ghi Danh TNTT",
        homepage_events_btn: "Sự kiện",
        back_to_home: "Quay lại Trang chủ",
        events_title: "Sự Kiện Sắp Tới",
        register_btn: "Đăng Ký Ngay",

        // ==================== FORM ĐĂNG KÝ CHUNG ====================
        form_title: "Form Ghi Danh",
        next_btn: "Tiếp theo",
        back_btn: "Quay lại",
        submit_btn: "Gửi Form",
        required_field_alert: "Vui lòng điền đầy đủ trường: ",
        form_submit_success: "Cảm ơn bạn đã đăng ký! Đơn ghi danh của bạn đã được gửi thành công.",
        ...
        step_rules: "Nội quy TNTT",

        // ==================== BƯỚC NGÀY SINH ====================
        dob_label: "Ngày sinh của bạn*",
        dob_step_title: "Bước 1: Nhập ngày sinh",
        dob_age_limit: "Đoàn sinh phải đủ 6 tuổi trở lên nhưng tuổi phải hợp lí.",
        camp_dob_step_title: "Thông Tin Người Tham Gia",

        // ==================== THÔNG TIN CÁ NHÂN ====================
        main_info_title: "Thông tin cá nhân",
        main_info_saint_name: "Tên Thánh*",
        main_info_last_name: "Họ*",
        main_info_middle_name: "Tên Đệm*",
        main_info_given_name: "Tên Gọi*",
        main_info_father_name: "Tên Bố*",
        main_info_mother_name: "Tên Mẹ*",
        main_info_street_address: "Địa chỉ nhà*",
        main_info_city: "Thành phố*",
        main_info_state: "Tiểu Bang*",
        main_info_zip: "Zipcode*",
        main_info_home_phone: "SĐT Home (Tùy chọn)",
        main_info_cell_phone: "SĐT Cell*",
        main_info_work_phone: "SĐT Work (Tùy chọn)",
        main_info_emergency_contact_name: "Liên hệ khẩn cấp (Tên)*",
        main_info_emergency_contact_phone: "Liên hệ khẩn cấp (SĐT)*",
        main_info_dob: "Ngày Sinh*",
        main_info_email: "Email*",

        // ==================== NGÀNH ====================
        nganh_label: "Ngành",
        nganh_aunhi_du_bi: "Ấu Nhi Dự Bị (6 tuổi)",
        nganh_aunhi_cap_1: "Ấu Nhi cấp 1 (7 tuổi)",
        nganh_aunhi_cap_2: "Ấu Nhi cấp 2 (8 tuổi)",
        nganh_aunhi_cap_3: "Ấu Nhi cấp 3 (9 tuổi)",
        nganh_thieunhi_cap_1: "Thiếu Nhi cấp 1 (10 tuổi)",
        nganh_thieunhi_cap_2: "Thiếu Nhi cấp 2 (11 tuổi)",
        nganh_thieunhi_cap_3: "Thiếu Nhi cấp 3 (12 tuổi)",
        nganh_nghiasi_cap_1: "Nghĩa Sĩ cấp 1 (13 tuổi)",
        nganh_nghiasi_cap_2: "Nghĩa Sĩ cấp 2 (14 tuổi)",
        nganh_nghiasi_cap_3: "Nghĩa Sĩ cấp 3 (15 tuổi)",
        nganh_hiepsi_cap_1: "Hiệp Sĩ cấp 1 (16 tuổi)",
        nganh_hiepsi_cap_2: "Hiệp Sĩ cấp 2 (17 tuổi)",
        nganh_invalid: "Không xác định",
        nganh_adult_option1: "Hiệp Sĩ Trưởng Thành",
        nganh_adult_option2: "Huynh Trưởng",
        nganh_adult_option3: "Trợ Tá",
        nganh_adult_option4: "Huấn Luyện Viên",

        // ==================== THANH TOÁN ====================
        payment_info_title: "Thông tin thanh toán",
        payment_annual_fee: "Tiền niên liễm (Bắt buộc)",
        payment_uniform_shirt: "Uniform Áo ($25)",
        payment_uniform_skort: "Uniform Skort ($25)",
        payment_scarf: "Khăn ($10) (dưới 18 tuổi)",
        payment_total: "Tổng cộng",

        // ==================== THÔNG TIN SỨC KHỎE ====================
        health_info_title: "Thông tin y tế",
        participant_info_title: "Thông tin của Đoàn sinh",
        health_info_section_title: "Thông tin y tế (Tùy chọn)",
        emergency_contact_title: "Liên hệ khẩn cấp",

        health_minor: "Đoàn sinh có phải vị thành niên?",
        health_gender: "Giới tính",
        gender_male: "Nam",
        gender_female: "Nữ",
        gender_required: "Vui lòng chọn giới tính.",

        health_parish: "Giáo xứ",
        health_diocese: "Giáo phận",
        health_parish_value: "Our Lady of Perpetual Help Church, Riverside, CA",
        health_diocese_value: "San Bernadino, CA",

        doctor_label: "Bác sĩ",
        doctor_phone_label: "Số điện thoại của Bác sĩ",
        insurance_co_label: "Công ty bảo hiểm",
        insurance_id_label: "Mã số bảo hiểm",
        insurance_group_label: "Số nhóm",
        insurance_cardholder_label: "Tên chủ thẻ",
        health_allergies_label: "DỊ ỨNG (bao gồm thuốc và thức ăn)",
        health_chronic_concerns_label: "CÁC VẤN ĐỀ SỨC KHOẺ MẠN TÍNH (vd: tiểu đường, các vấn đề về tinh thần và hành vi, bao gồm cả việc sử dụng ma túy)",
        health_physical_restrictions_label: "CÁC HẠN CHẾ VỀ THỂ CHẤT KHÁC",

        emergency_contact_name_label: "Tên",
        emergency_contact_phone_label: "Số điện thoại",
        emergency_contact_relationship_label: "Mối quan hệ",
        emergency_contact_name_required: "Vui lòng nhập tên người liên hệ khẩn cấp.",
        emergency_contact_phone_required: "Vui lòng nhập số điện thoại người liên hệ khẩn cấp.",
        emergency_contact_relationship_required: "Vui lòng nhập mối quan hệ.",

        // ==================== CHỮ KÝ ====================
        signature_name_placeholder: "Nhập tên người ký",
        signature_signed_name: "Người ký:",
        ...
        parent_signature_required: "Vui lòng ký tên của phụ huynh vào đây.",

        // ==================== MIỄN TRỪ ====================
        waiver_title: "Miễn trừ và Bồi thường",
        waiver_content: "Tuyên bố miễn trừ của Đoàn Thiếu Nhi Thánh Thể",
        waiver_intro_part1: `Tôi,`,
        waiver_intro_part2: `, là một người trưởng thành [đủ tuổi vị thành niên, theo luật Tiểu bang (ví dụ: 18 tuổi ở California)] và là người tham gia được nêu tên, hoặc tôi là phụ huynh/người giám hộ của người vị thành niên sẽ tham gia vào sự kiện nói trên ("Sự kiện") được tổ chức và/hoặc tài trợ bởi Phong Trào Thiếu Nhi Thánh Thể Việt Nam tại Hoa Kỳ ("VEYM"). <a style="text-decoration: underline">Tôi hoàn toàn nhận thức rằng việc tôi hoặc con tôi tham gia Sự kiện là hoàn toàn tự nguyện.</a> Trong khi đó, tôi hoặc con tôi sẽ tuân thủ tất cả các Quy tắc Ứng xử hiện hành, và nói chung sẽ cư xử mọi lúc phù hợp với các tiêu chuẩn đạo đức và luân lý cao nhất, và tuân thủ tất cả các quy tắc pháp luật hiện hành, để phản ánh tích cực về bản thân/người đó, Sự kiện và các giáo lý Công giáo. Nếu tôi hoặc con tôi vi phạm những nghĩa vụ này dẫn đến thương tích cơ thể hoặc thiệt hại tài sản trong Sự kiện, tôi hoặc con tôi đã vi phạm những nghĩa vụ này sẽ tự mình chịu trách nhiệm trả tiền để khôi phục hoặc thay thế bất kỳ tài sản nào bị hư hại do vi phạm, trả bất kỳ thiệt hại nào gây ra cho thương tích cơ thể cho một cá nhân, và bảo vệ, bảo vệ và giữ cho VEYM, các thành viên điều hành, các huynh trưởng, và các tình nguyện viên, giáo phận địa phương, các linh mục hoặc các thành viên tôn giáo hoặc giáo sĩ khác, không bị tổn hại, khỏi các yêu cầu bồi thường thương tích cơ thể hoặc thiệt hại tài sản đó.`,
        waiver_full_text_part1: `Tôi nhận thức rằng Sự kiện có thể bao gồm nhưng không giới hạn ở các hoạt động sau: chạy, nhảy, chia sẻ những câu chuyện cá nhân, hát, vỗ tay, la hét, ngồi trong thời gian dài, thức dậy sớm, ngủ trong lều, sử dụng nhà vệ sinh thiếu án sáng, các hoạt động ngoài trời trên đất, địa hình không bằng phẳng, bụi bặm và đá, ngủ ngoài trời, các hoạt động dưới nước, và các hoạt động nhóm trực tuyến có giám sát sử dụng các công cụ bao gồm, nhưng không giới hạn ở Google Meets, Microsoft Teams, và Zoom, theo Đạo luật Bảo vệ Quyền riêng tư Trực tuyến của Trẻ em năm 1998, (15 U.S.C. 6501, et seq.,). Tất cả các hoạt động sẽ được giám sát bởi ít nhất 2 người lớn. Để xem xét thỏa thuận, bởi các huynh trưởng và/hoặc ủy ban điều hành của đoàn địa phương, để cho phép tôi hoặc con tôi tham gia Sự kiện, việc nhận và sự đầy đủ trong việc xem xét này được thừa nhận, tôi, `,
        waiver_full_text_part2: `, đồng ý như sau`,

        waiver_initial_prompt: "Vui lòng ký tên tắt để đồng ý",
        sign_initial_btn: "Ký tên tắt",
        initial_required_text: "Vui lòng ký tên tắt vào mục này.",

        waiver_final_section1: "Tôi đồng ý rằng thỏa thuận này sẽ được hiểu theo luật của Tiểu bang California và có ý định rộng và bao gồm nhất có thể theo luật pháp cho phép, và nếu bất kỳ phần nào của nó bị coi là không hợp lệ, thì phần còn lại sẽ tiếp tục có hiệu lực pháp lý đầy đủ. Ngoài ra, tôi đồng ý rằng bất kỳ hành động pháp lý nào phát sinh từ hoặc liên quan đến thỏa thuận này phải được đưa ra tại tòa án Tiểu bang California, Hạt Riverside.",
        waiver_final_section2: "Trong phạm vi luật pháp hoặc án lệ không cấm miễn trừ trách nhiệm pháp lý đối với sơ suất, việc miễn trừ này cũng áp dụng cho sơ suất.",
        waiver_final_section3: "Tôi bằng văn bản này cấp cho VEYM sự đồng ý của tôi mà không có sự bảo lưu để sử dụng, giao, chuyển nhượng, sao chép, bản quyền, xuất bản hoặc bán tên, giọng nói, hình ảnh và/hoặc hình dạng của tôi phát sinh từ việc tôi tham gia Sự kiện, dù là ảnh tĩnh hay phim chuyển động, băng âm thanh hay video, cho mục đích quảng cáo, hướng dẫn, kinh doanh hoặc bất kỳ mục đích hợp pháp nào khác, theo quyết định riêng của VEYM, nếu bất kỳ tên, giọng nói, hình ảnh và/hoặc hình dạng nào đó được chia sẻ với VEYM bởi đoàn địa phương.",
        waiver_final_section4: "<strong>KHI KÝ TÊN THỎA THUẬN NÀY, TÔI BẰNG VĂN BẢN NÀY THỪA NHẬN VÀ CAM ĐOAN RẰNG TÔI ĐÃ ĐỌC TOÀN BỘ TÀI LIỆU NÀY, RẰNG TÔI HIỂU CÁC ĐIỀU KHOẢN VÀ ĐIỀU KHOẢN CỦA NÓ, RẰNG TÔI HIỂU NÓ ẢNH HƯỞNG ĐẾN QUYỀN LỢI PHÁP LÝ CỦA TÔI, RẰNG NÓ LÀ MỘT THỎA THUẬN RÀNG BUỘC, VÀ TÔI ĐÃ KÝ TÊN NÓ MỘT CÁCH HIỂU BIẾT VÀ TỰ NGUYỆN. TÔI NHẬN THỨC RẰNG ĐÂY LÀ MỘT SỰ MIỄN TRỪ TRÁCH NHIỆM PHÁP LÝ VÀ MỘT HỢP ĐỒNG VÀ TÔI KÝ NÓ THEO Ý MUỐN TỰ DO CỦA MÌNH. <br/><br/>BẰNG CÁCH KÝ TÊN VIỆC MIỄN TRỪ NÀY, TÔI CŨNG THỪA NHẬN RẰNG TÔI HIỂU NỘI DUNG CỦA NÓ VÀ RẰNG VIỆC MIỄN TRỪ NÀY KHÔNG THỂ ĐƯỢC SỬA ĐỔI BẰNG MIỆNG.</strong><br/>",
        ...
        waiver_sections_with_initials: [
            ...
            {
                text: "2. Đồng ý bồi thường (bù đắp cho thiệt hại hoặc mất mát), bảo vệ và giữ cho VEYM và nhân viên, tình nguyện viên, đại lý, người phục vụ, sĩ quan, người ủy thác, đại diện, chi nhánh và nhà tài trợ của họ, với tư cách chính thức và cá nhân, cũng như Giáo xứ và Giáo phận của tôi, nhân viên và đại lý, đại diện, nhà tài trợ, người giám hộ, hoặc tình nguyện viên của họ, không bị tổn hại, chống lại tất cả các khiếu nại, bao gồm, nhưng không giới hạn, các khiếu nại về sơ suất, hành động không cố ý và hành động bỏ sót, và khỏi bất kỳ và tất cả trách nhiệm pháp lý, mất mát hoặc thiệt hại mà họ phải chịu do bất kỳ khiếu nại, yêu cầu, hành động, nguyên nhân hành động, phán quyết, chi phí hoặc chi phí mà họ phải gánh chịu, bao gồm cả phí luật sư, phát sinh từ hoặc có liên quan đến việc tôi hoặc con tôi tham gia Sự kiện, bao gồm nhưng không giới hạn ở việc tôi đi đến và từ Sự kiện.",
                initialKey: "indemnify"
            },
            {
                text: "3. Có một số mối nguy hiểm cố hữu và rủi ro có thể đoán trước và không thể đoán trước về tổn hại đối với bản thân tôi, con tôi và những người khác phát sinh từ các hoạt động khác nhau của Sự kiện, bao gồm nhưng không giới hạn ở việc duy trì thương tích cơ thể hoặc cảm xúc, có thể là kết quả của việc tôi tham gia Sự kiện. Các thương tích có thể phát sinh từ hành động hoặc không hành động của tôi, hành động hoặc không hành động của người tham gia khác trong các hoạt động, hoặc việc bất kỳ huynh trưởng, đại lý hoặc tình nguyện viên nào thực tế hoặc bị cáo buộc không huấn luyện, đào tạo, hướng dẫn hoặc giám sát đầy đủ các hoạt động. Tôi đã cố ý và tự nguyện quyết định chấp nhận rủi ro của những mối nguy hiểm cố hữu này để được phép, bởi các huynh trưởng và/hoặc ủy ban điều hành của đoàn địa phương, cho phép tôi hoặc con tôi tham gia Sự kiện.",
                initialKey: "acknowledge"
            },
            {
                text: "4. Cho dù có dịch bệnh hay không, các bệnh truyền nhiễm (ví dụ như cúm thông thường hoặc coronavirus) có thể được mang theo bởi bất kỳ người nào trong khuôn viên. Các người mang mầm bệnh có thể không được biết đến hoặc không được xác định bởi VEYM, các giám đốc và sĩ quan của nó, các thành viên ủy ban điều hành, các huynh trưởng và các tình nguyện viên. Khi các cuộc họp trực tiếp trong khuôn viên được giáo phận của tôi cho phép theo hướng dẫn của các cơ quan y tế chính phủ và địa phương, có một rủi ro cố hữu là việc con tôi hoặc tôi tham gia có thể khiến tôi có nguy cơ tiếp xúc, và tôi chấp nhận tất cả các rủi ro có thể đoán trước và không thể đoán trước về tổn hại mà tôi hoặc con tôi có thể phải chịu từ đó.",
                initialKey: "diseases"
            },
            {
                text: "5. Các điều kiện thời tiết, bao gồm Thiên tai, hoặc các nguyên nhân tự nhiên (mà con người không can thiệp để gây ra), có thể thay đổi hoặc ảnh hưởng đến các kế hoạch, chi phí và hoạt động liên quan đến, và bao gồm, Sự kiện, và tôi hiểu rằng các mối nguy hiểm cố hữu và rủi ro tổn hại đối với bản thân tôi, con tôi và những người khác do các nguyên nhân tự nhiên đó có thể thay đổi, và tôi chấp nhận tất cả các rủi ro có thể đoán trước và không thể đoán trước về tổn hại mà tôi hoặc con tôi có thể phải chịu từ đó.",
                initialKey: "weather"
            },
            {
                text: "6. Tài sản cá nhân của tôi hoặc con tôi có thể có nguy cơ bị trộm cắp, hư hỏng hoặc mất mát hoàn toàn.",
                initialKey: "property"
            },
            {
                text: "7. VEYM có quyền từ chối, chấp nhận, hoặc giữ lại tôi hoặc con tôi trong Sự kiện bất cứ lúc nào nếu hành động hoặc hành vi chung của tôi cản trở hoạt động của Sự kiện hoặc quyền lợi hoặc phúc lợi của bất kỳ người nào khác. <a style=\"text-decoration: underline\">Tôi hiểu rằng tôi hoặc con tôi có thể được yêu cầu rời khỏi Sự kiện theo quyết định riêng của các nhà tổ chức, đại lý và đại diện</a>. Nếu tôi hoặc con tôi bị yêu cầu rời đi, sẽ không có khoản hoàn lại nào được trao cho tôi hoặc con tôi cho bất kỳ phần nào chưa sử dụng của Sự kiện, và đoàn địa phương sẽ không bồi thường cho tôi bất kỳ chi phí hoặc chi phí trực tiếp hoặc gián tiếp nào mà tôi hoặc con tôi đã phải chịu do việc tôi hoặc con tôi tham gia Sự kiện.",
                initialKey: "decline"
            },
            {
                text: "8. Tôi hiểu rằng VEYM, theo quyết định riêng của mình, có quyền hủy bỏ Sự kiện hoặc bất kỳ khía cạnh nào của nó trước khi bắt đầu. Trong trường hợp hủy bỏ toàn bộ hoặc một phần Sự kiện, tôi chấp nhận rằng tôi hoặc con tôi có thể không được hoàn trả hoặc hoàn lại tiền cho bất kỳ phần nào chưa sử dụng của Sự kiện.",
                initialKey: "cancel"
            },
            {
                text: "Tôi cam đoan và đảm bảo rằng tôi hoặc con tôi được bảo hiểm toàn diện về sức khỏe và tai nạn trong suốt Sự kiện, cung cấp bảo hiểm cho các thương tích mà tôi hoặc con tôi có thể phải chịu khi tham gia Sự kiện. Tuy nhiên, ngay cả khi tôi hoặc con tôi không được bảo hiểm y tế nào trong Sự kiện, tôi đồng ý hoàn thành phần THÔNG TIN SỨC KHOẺ với khả năng tốt nhất của mình và, bằng cách hoàn thành nó, tôi bằng văn bản này miễn trừ và giải phóng VEYM khỏi mọi trách nhiệm và nghĩa vụ đối với bất kỳ thương tích, bệnh tật, hóa đơn y tế, phí hoặc chi phí tương tự nào mà tôi có thể phải chịu khi tham gia Sự kiện. Bằng cách hoàn thành biểu mẫu, tôi bằng văn bản này cho phép VEYM có được bất kỳ điều trị y tế cần thiết nào cho bản thân tôi hoặc con tôi, đồng ý với bất kỳ kiểm tra, điều trị hoặc chăm sóc cần thiết nào dưới sự giám sát và/hoặc tư vấn của bất kỳ chuyên gia y tế nào được cấp phép hợp lệ, và tôi rõ ràng cho phép VEYM tiết lộ thông tin y tế về tôi hoặc con tôi cho bất kỳ người hoặc tổ chức nào mà VEYM giới thiệu tôi đến để điều trị y tế.",
                initialKey: "health"
            },
        ],
...
<ol>
  ...
  <li>Linh mục sẽ nói chuyện với toàn thể Đoàn TNTT về người vi phạm và loại người đó ra khỏi TNTT.</li>
        ...
        saveForm: {
            title: 'Lưu đơn đăng ký',
            saving: 'Đang lưu dữ liệu...',
            success: 'Lưu thành công! Tài khoản đã được tạo hoặc cập nhật.',
            error: 'Đã xảy ra lỗi khi lưu đơn.',
            noFormData: 'Không có dữ liệu để lưu.',
            missingPassword: 'Vui lòng nhập mật khẩu (tối thiểu 6 ký tự).',
            enterPasswordPrompt: 'Email chưa có tài khoản. Vui lòng nhập mật khẩu để tạo tài khoản.',
            passwordPlaceholder: 'Nhập mật khẩu...',
            createAccount: 'Tạo tài khoản và lưu đơn',
            viewDashboard: 'Xem đơn đã nộp',
            goHome: 'Về trang chủ',
        },
        dashboard: {
            title: 'Bảng điều khiển người dùng',
            welcome: 'Xin chào',
            noForms: 'Bạn chưa nộp đơn đăng ký nào.',
        },
        form: {
            name: 'Họ và tên',
            type: 'Loại đơn',
            camp: 'Trại Bình Minh',
            regular: 'Đăng ký thường',
        ...
        error: {
            fetchForms: 'Không thể lấy dữ liệu đơn đăng ký.',
            saveForm: 'Không thể lưu đơn đăng ký.',
            noFormData: 'Không có dữ liệu để xử lý.',
        },
        logout: 'Đăng xuất',
        loading: 'Đang tải...',
        login: {
    ...
    en: {
        // ==================== HOME PAGE & GENERAL ====================
        homepage_title: "Welcome to the Vietnamese Eucharistic Youth Movement Registration for Đoàn Mẹ Thiên Chúa",
        homepage_subtitle: "Select an option below to continue.",
        homepage_register_btn: "Registration VEYM",
        homepage_events_btn: "Events",
        ...
        required_field_alert: "Please fill out the field: ",
        form_submit_success: "Thank you for registering! Your application has been submitted successfully.",
        ...
        step_health: "Health",
        step_waiver: "Waiver",
        step_rules: "VEYM Rules",

        // ==================== DATE OF BIRTH STEP ====================
        dob_label: "Your Date of Birth*",
        dob_step_title: "Step 1: Enter your Date of Birth",
        dob_age_limit: "Participant must be at least 6 years old but of reasonable age.",
        camp_dob_step_title: "Participant Information",

        // ==================== PERSONAL INFORMATION ====================
        main_info_title: "Personal Information",
        main_info_saint_name: "Saint Name*",
        main_info_last_name: "Last Name*",
        main_info_middle_name: "Middle Name*",
        main_info_given_name: "Given Name*",
        main_info_father_name: "Father's Name*",
        main_info_mother_name: "Mother's Name*",
        main_info_street_address: "Street Address*",
        main_info_city: "City*",
        main_info_state: "State*",
        main_info_zip: "Zip*",
        main_info_home_phone: "Home Phone (Optional)",
        main_info_cell_phone: "Cell Phone*",
        main_info_work_phone: "Work Phone (Optional)",
        main_info_emergency_contact_name: "Emergency Contact Name*",
        main_info_emergency_contact_phone: "Emergency Contact Phone*",
        main_info_dob: "Date of Birth*",
        main_info_email: "Email*",
        ...
        payment_annual_fee: "Annual Fee (Required)",
        payment_uniform_shirt: "Uniform Shirt ($25)",
        payment_uniform_skort: "Uniform Skort ($25)",
        payment_scarf: "Scarf ($10) (under 18)",
        payment_total: "Total Amount",

        // ==================== HEALTH INFORMATION ====================
        health_info_title: "Health Information",
        participant_info_title: "Participant's Information",
        health_info_section_title: "Health Information (Optional)",
        emergency_contact_title: "Emergency Contact",

        health_minor: "Is participant a minor?",
        health_gender: "Gender",
        gender_male: "Male",
        gender_female: "Female",
        gender_required: "Please select a gender.",

        health_parish: "Parish",
        health_diocese: "Diocese",
        health_parish_value: "Our Lady of Perpetual Help Church, Riverside, CA",
        health_diocese_value: "San Bernadino, CA",

        doctor_label: "Doctor",
        doctor_phone_label: "Doctor's Phone Number",
        insurance_co_label: "Insurance Company",
        insurance_id_label: "Insurance ID",
        insurance_group_label: "Group #",
        insurance_cardholder_label: "Cardholder's Name",
        health_allergies_label: "PARTICIPANT'S ALLERGIES (including meds and food)",
        health_chronic_concerns_label: "CHRONIC MEDICAL CONCERNS (e.g. diabetes, or any mental behavior and health issues, including drug use)",
        health_physical_restrictions_label: "OTHER PHYSICAL RESTRICTIONS",
        ...
        emergency_contact_name_required: "Please enter the emergency contact's name.",
        emergency_contact_phone_required: "Please enter the emergency contact's phone number.",
        emergency_contact_relationship_required: "Please enter the relationship to the emergency contact.",

        // ==================== SIGNATURES ====================
        signature_name_placeholder: "Enter signer's name",
        signature_signed_name: "Signer's Name:",
        signature_date: "Date:",
...
<ol>
  ...
  <li>The priest will talk with the entire VEYM about the wrongdoer and expel him/her out of the Eucharistic Youth.</li>
        ...
        saveForm: {
            ...
            success: 'Saved successfully! Your account has been created or updated.',
            error: 'An error occurred while saving the form.',
            noFormData: 'No data available to save.',
            missingPassword: 'Please enter a password (minimum 6 characters).',
            enterPasswordPrompt: 'This email does not have an account. Please enter a password to create one.',
            passwordPlaceholder: 'Enter password...',
            createAccount: 'Create account and save form',
            viewDashboard: 'View submitted forms',
            goHome: 'Return to homepage',
        },
        dashboard: {
            title: 'User Dashboard',
            welcome: 'Welcome',
            noForms: 'You have not submitted any forms yet.',
        },
        form: {
            name: 'Full Name',
            type: 'Form Type',
        ...
        error: {
            fetchForms: 'Unable to retrieve registration data.',
            saveForm: 'Unable to save registration form.',
            noFormData: 'No data to process.',
        },
        logout: 'Log Out',
        loading: 'Loading...',
        login: {
