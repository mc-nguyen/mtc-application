    ...
    <div className="form-section">
      ...
      <div className="input-group-row">
        <div>
          ...
          <input type="text" value={formData.mainInfo.lastName || ''} disabled />
        </div>
        <div>
      ...
      <div className="input-group-row">
        <div>
          ...
          <input type="text" value={formData.mainInfo.city || ''} disabled />
        </div>
        <div>
          <label>{t('main_info_state')}</label>
          <input type="text" value={formData.mainInfo.state || ''} disabled />
        </div>
        <div>
          <label>{t('main_info_zip')}</label>
          <input type="text" value={formData.mainInfo.zip || ''} disabled />
        </div>
      </div>
      ...
      <div className="input-group-row">
        <div>
          ...
          <input type="tel" value={formData.mainInfo.cellPhone || ''} disabled />
        </div>
        <div>
          <label>{t('main_info_email')}</label>
          <input type="email" value={formData.mainInfo.email || ''} disabled />
        </div>
        <div>
      ...
      <div className="input-group-row">
        <div>
          <label>{t('health_minor')}</label>
          <input type="text" value={formData.isAdult ? t('no') : t('yes')} disabled />
        </div>
        <div className="gender-row">
          <label>{t('health_gender')}*</label>
          <div>
            <label>
      ...
      <div className="input-group-row">
        <div>
          <label>{t('health_parish')}</label>
          <input type="text" value={t('health_parish_value')} disabled />
        </div>
        <div>
          <label>{t('health_diocese')}</label>
          <input type="text" value={t('health_diocese_value')} disabled />
        </div>
      </div>
      ...
      <div className="input-group-row">
        <div>
          ...
          <input type="text" name="doctor" value={formData.healthInfo.doctor || ''} onChange={handleHealthInfoChange} />
        </div>
        <div>
          <label>{t('doctor_phone_label')}</label>
          <input type="tel" name="doctorPhone" value={formData.healthInfo.doctorPhone || ''} onChange={handleHealthInfoChange} />
        </div>
      </div>

      <div className="input-group-row">
        <div>
          <label>{t('insurance_co_label')}</label>
          <input type="text" name="insuranceCo" value={formData.healthInfo.insuranceCo || ''} onChange={handleHealthInfoChange} />
        </div>
        <div>
          <label>{t('insurance_id_label')}</label>
          <input type="text" name="insuranceId" value={formData.healthInfo.insuranceId || ''} onChange={handleHealthInfoChange} />
        </div>
        <div>
          <label>{t('insurance_group_label')}</label>
          <input type="text" name="insuranceGroup" value={formData.healthInfo.insuranceGroup || ''} onChange={handleHealthInfoChange} />
        </div>
        <div>
          <label>{t('insurance_cardholder_label')}</label>
          <input type="text" name="insuranceCardholder" value={formData.healthInfo.insuranceCardholder || ''} onChange={handleHealthInfoChange} />
        </div>
      </div>

      <div>
        <label>{t('health_allergies_label')}</label>
        <textarea name="allergies" value={formData.healthInfo.allergies || ''} onChange={handleHealthInfoChange} rows="4"></textarea>
      </div>
      ...
      <div className="input-group-row">
        <div>
          ...
          <input type="text" name="name" value={formData.healthInfo.emergencyContact?.name || ''} onChange={handleEmergencyContactChange} />
        ...
        <div>
          <label>{t('emergency_contact_phone_label')}*</label>
          <input type="tel" name="phone" value={formData.healthInfo.emergencyContact?.phone || ''} onChange={handleEmergencyContactChange} />
        ...
        <div>
          <label>{t('emergency_contact_relationship_label')}*</label>
          <input type="text" name="relationship" value={formData.healthInfo.emergencyContact?.relationship || ''} onChange={handleEmergencyContactChange} />
